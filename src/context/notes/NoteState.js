  ...
  const fetchallnotes = async () => {
    const response = await fetch(`${port}/api/notes/fetchallnotes`, {
      ...
      headers: {
        ...
        'auth-token': "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7ImlkIjoiNjM1NDNkYjgzYTlkNjYwODk1MjkyYjdmIn0sImlhdCI6MTY2NjQ2NTIwOH0.qnvWDM2i3LWTJijEsbbdDizZ_hMgtIta3vk53ormKLo"
      },
    });
